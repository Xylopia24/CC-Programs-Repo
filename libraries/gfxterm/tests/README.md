...
| `test_resize_font.lua` | `gfx.resize()` carrying the shadow buffer across a shrink and a grow, and fonts that are not 6x9 — including a 12-wide glyph whose rows span two bytes. |
